...
const ROLES: RoleSection[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Mark-won queues in Approvals and only takes effect once you approve — a deal isn't Won until then. Follow-ups do not: sales record those as they happen, and you read them on the customer's timeline.",
