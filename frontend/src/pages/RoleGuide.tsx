...
const ROLES: RoleSection[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Stage transitions (lead → presentation → … → won), quotations, customer POs, sales follow-ups, and Mark-won requests all go to the director, not you — your own stage moves on customers also go through the director.",
    ...
    rules_id: [
      ...
      "Pindah tahap (lead → presentasi → … → menang), penawaran, PO pelanggan, tindak lanjut sales, dan permintaan Mark-won semuanya ke direktur — pindah tahap Anda sendiri di pelanggan juga lewat direktur.",
  ...
  },
  {
    ...
    rules: [
      ...
      "Only YOU can approve a manual CRM stage transition — but approving a deal document moves the stage for you: quotation approval → 'quotation', Mark-Won approval → 'negotiation', customer PO approval → 'po'. One decision drives both records.",
