...
const ROLES: RoleSection[] = [
  {
    ...
    flow: [
      ...
      { title: "Advance to Presentation → send deck", detail: "Use the AI Suggest button for a Bahasa follow-up" },
      { title: "Advance to Quotation → + New quotation", detail: "Discount ≤5% auto, ≤15% manager, >15% director" },
      { title: "Submit → wait for approval → Send", detail: "Customer accepts" },
      { title: "Mark deal Won", detail: "Director takes over for the supplier PO" },
    ],
    buttons: [
      { page: "Customers", button: "+ New customer", effect: "Add a company" },
      { page: "Customer page", button: "Advance to …", effect: "Move the deal one stage forward" },
  ...
  },
  {
    ...
    daily: "Monday: Executive Dashboard + AI Recommendations. End of month: Salary.",
    flow: [
      { title: "Monday: Executive Dashboard", detail: "Read the AI recommendations" },
      { title: "Approvals: clear discounts >15%" },
    ...
    buttons: [
      ...
      { page: "Approvals", button: "Approve / Reject", effect: "Final word on big changes" },
      { page: "Executive Dashboard", button: "AI Recommendations", effect: "Upsell ideas & supplier switches" },
    ],
    rules: [
      "Only YOU can issue a PO and decide which supplier serves which project.",
      "That keeps the customer ↔ supplier mapping private — vendors never see who they're really working for.",
